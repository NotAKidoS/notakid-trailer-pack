...
list.Set( "simfphys_lights", "pounder_lights", light_table)
...
local V = {
	Name = "Pounder",
	Model = "models/notakid/gtavredux/Pounder/Pounder_main.mdl",
	...
	Members = {
        ...
        OnSpawn = function(ent)
            if ent:GetCenterposition() != nil then
                ent:SetCenterposition(Vector(-120,0,6))  -- position of center ballsocket for tow hitch(trailer coupling)
                ent:SetTrailerCenterposition(Vector(100,0,0)) -- position of center ballsocket for trailer hook
            end
        end,
		
		
		LightsTable = "pounder_lights",
		
		CustomWheels = true,
		CustomSuspensionTravel = 0,
		StrengthenSuspension = true,
		
		CustomWheelModel = "models/notakid/gtavredux/Pounder/Pounder_f_wheel.mdl",
		CustomWheelModel_R = "models/notakid/gtavredux/Pounder/Pounder_r_wheel.mdl",
		CustomWheelPosFL = Vector(126,-47,-20),
		CustomWheelPosFR = Vector(126,47,-20),
		CustomWheelPosML = Vector(-171,-43,-17),
		CustomWheelPosMR = Vector(-171,43,-17),
		CustomWheelPosRL = Vector(-220,-43,-17),
		CustomWheelPosRR = Vector(-220,43,-17),
...
list.Set( "simfphys_vehicles", "sim_fphys_gtav_Pounderreduxextra", V )